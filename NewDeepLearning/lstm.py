...
# df = pd.read_csv("C:/Git_project/forecast/forecast/NewDeepLearning/SPY.csv")
df = pd.read_csv("C:/Git_project/forecast/forecast/NewDeepLearning/khmotor-D1.CSV")

## Datetime conversion
df['Date'] = pd.to_datetime(df.Date)
# df['<DTYYYYMMDD>'] = pd.to_datetime(df.Date)
...
# df.drop(['<TICKER>','<PER>', '<TIME>','<OPEN>','<HIGH>','<LOW>','<VOL>','<OPENINT>'], axis=1, inplace=True)
